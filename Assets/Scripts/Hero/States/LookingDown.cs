...
{
    public class LookingDown : HeroState
    {
        private Rigidbody2D rgb;
        private Animator animHero;
        //public string animationAttribute = "LookingDown";
        public LookingDown(HeroController hero, HeroStateMachine herosfm) : base(hero, herosfm)
        {
            rgb = hero.GetComponent<Rigidbody2D>();
            animHero = hero.GetComponent<Animator>();
            this.animationAttribute = "LookingDown";
        }
